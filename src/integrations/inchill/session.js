const {
  createSessionSecretCipherFromEnv,
  isEncryptedSessionSecret,
} = require("./sessionSecrets");

function encryptSessionForStorage(
  cookies,
  cipher = createSessionSecretCipherFromEnv(),
) {
  return {
